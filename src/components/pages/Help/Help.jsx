...
const Help = () => {
  ...
  return (
    <HelpPageStyled>
      <h2 className="helpTitle">Help Center</h2>
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item">
          <h2 className="accordion-header" id="headingThree">
            ...
            >
              Order status delivering, when could it be completed?
            </button>
          </h2>
          <div
            id="collapseThree"
        ...
        <div className="accordion-item">
          <h2 className="accordion-header" id="headingTwo">
            <button
              ...
              aria-controls="collapseTwo"
            >
              Does Fut Coins Market Cover the 5% Tax?
            </button>
          </h2>
          <div
            id="collapseTwo"
        ...
        <div className="accordion-item">
          <h2 className="accordion-header" id="headingThree">
            <button
              ...
              aria-controls="collapseThree"
            >
              I dont get full coins after the orders says Completed?
            </button>
          </h2>
          <div
            id="collapseThree"
